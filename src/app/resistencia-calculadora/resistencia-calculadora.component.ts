...
@Component({
  selector: 'app-resistencia-calculadora',
  templateUrl: './resistencia-calculadora.component.html',
  styleUrls: ['./resistencia-calculadora.component.css']
})
export class ResistenciaCalculadoraComponent implements OnInit {
